...
import com.example.cabify.filter.JwtRequestFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/users/register", "/api/users/**", "/api/drivers/**", "/api/rides/**", "/api/payments/**","/api/receipt/**","/api/ratings","/api/ratings/**").permitAll()
